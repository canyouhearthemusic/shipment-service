...
func (x *AddShipmentEventRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *GetShipmentEventsRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
const file_shipment_v1_shipment_proto_rawDesc = "" +
	"\n" +
	"\x1ashipment/v1/shipment.proto\x12\vshipment.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xab\x03\n" +
	"\bShipment\x12\x0e\n" +
	...
	"shipmentId\x123\n" +
	"\x06status\x18\x03 \x01(\x0e2\x1b.shipment.v1.ShipmentStatusR\x06status\x12;\n" +
	...
	"\bshipment\x18\x01 \x01(\v2\x15.shipment.v1.ShipmentR\bshipment\"^\n" +
	"\x17AddShipmentEventRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x123\n" +
	"\x06status\x18\x02 \x01(\x0e2\x1b.shipment.v1.ShipmentStatusR\x06status\"M\n" +
	"\x18AddShipmentEventResponse\x121\n" +
	"\bshipment\x18\x01 \x01(\v2\x15.shipment.v1.ShipmentR\bshipment\"*\n" +
	"\x18GetShipmentEventsRequest\x12\x0e\n" +
	...
	"\x19SHIPMENT_STATUS_CANCELLED\x10\x052\x83\x03\n" +
	...
	"\x11GetShipmentEvents\x12%.shipment.v1.GetShipmentEventsRequest\x1a&.shipment.v1.GetShipmentEventsResponseBKZIgithub.com/canyouhearthemusic/shipment-service/gen/shipment/v1;shipmentv1b\x06proto3"
...
var file_shipment_v1_shipment_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
var file_shipment_v1_shipment_proto_depIdxs = []int32{
	...
	1,  // 8: shipment.v1.AddShipmentEventResponse.shipment:type_name -> shipment.v1.Shipment
